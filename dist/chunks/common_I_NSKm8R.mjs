import { d as createAstro, c as createComponent, m as maybeRenderHead, u as unescapeHTML, b as renderTemplate, e as renderSlot, r as renderComponent, f as addAttribute, g as renderScript, h as Fragment, i as defineStyleVars, a as AstroUserError, s as spreadAttributes, j as renderHead } from './astro/server_0r96vtOq.mjs';
import 'piccolore';
import { s as starlightConfig, a as stripTrailingSlash, b as stripLeadingSlash, c as stripHtmlExtension, e as ensureHtmlExtension, d as ensureTrailingSlash, p as project, B as BuiltInDefaultLocale, g as getCollection, f as getCollectionPathFromRoot, h as pickLang, i as stripLeadingAndTrailingSlashes, j as ensureLeadingSlash, k as stripExtension, l as getEntry, u as useTranslations, r as renderEntry } from './translations_BX31cYDu.mjs';
/* empty css                          */
import { p as printHref } from './index.9f91b58d_BqzpA5ek.mjs';
import 'clsx';
import { $ as $$Icon, a as $$LinkButton, b as $$Badge } from './Code_DwmmcRIC.mjs';
import { $ as $$Image } from './_astro_assets_CftEws6K.mjs';
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Banner.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/ContentPanel.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/ContentNotice.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/FallbackContentNotice.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/DraftContentNotice.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/EditLink.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/LastUpdated.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Pagination.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Footer.astro", void 0);

const $$Astro$l = createAstro();
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$l, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${renderComponent($$result, "DefaultFooter", $$Footer$1, { ...Astro2.props })} ${maybeRenderHead()}<div class="relative left-1/2 right-1/2 mt-16 w-screen -ml-[50vw] -mr-[50vw] border-t-4 border-[#78081c] bg-gray-100"> <footer class="px-4 py-10 text-sm leading-6 text-gray-700 sm:px-6"> <div class="mx-auto max-w-5xl"> <div class="mb-10 flex items-center gap-3"> <img src="/book.png" alt="Logo" class="h-8 w-auto"> <span class="text-xl font-extrabold uppercase tracking-wide text-gray-900">CIC Handbook</span> </div> <div class="grid grid-cols-1 gap-8 border-b border-gray-200 pb-10 md:grid-cols-[1.5fr_1fr_1fr]"> <div class="space-y-3"> <h3 class="m-0 text-base font-bold text-[#78081c]">Acknowledgement</h3> <p class="m-0 text-gray-600">
The CIC Handbook was produced on Whadjuk Noongar Boodjar, the lands of the Traditional Custodians in Perth, Western
            Australia. We pay our respects to Elders past and present and extend that respect to all Aboriginal and Torres
            Strait Islander peoples today. We acknowledge that sovereignty was never ceded.
</p> </div> <div class="space-y-3"> <h3 class="m-0 text-base font-bold text-[#78081c]">About this guide</h3> <p class="m-0 text-gray-600">
This handbook is a plain-language toolkit designed to help victims of crime navigate the Criminal Injuries
            Compensation process in Australia. It aims to reduce confusion and empower applicants with clear, accessible
            information.
</p> </div> <div class="space-y-3"> <h3 class="m-0 text-base font-bold text-[#78081c]">Quick Links</h3> <ul class="m-0 list-none space-y-2 p-0"> <li> <a href="/" class="inline-block font-semibold text-gray-900 no-underline transition hover:translate-x-1 hover:text-[#78081c]">
Home
</a> </li> <li> <a href="/cic-guide" class="inline-block font-semibold text-gray-900 no-underline transition hover:translate-x-1 hover:text-[#78081c]">
Western Australian Guide
</a> </li> <li> <a href="/support-services" class="inline-block font-semibold text-gray-900 no-underline transition hover:translate-x-1 hover:text-[#78081c]">
Support Services
</a> </li> </ul> </div> </div> <div class="flex justify-end pt-6 text-xs font-medium text-gray-400">
&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} CIC Handbook WA.
</div> </div> </footer> </div>`;
}, "/Users/ellievrankovich/projects/cic-handbook/src/components/layout/Footer.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Head.astro", void 0);
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav id="custom-nav" class="sticky top-0 z-50 w-full border-b border-transparent bg-white/90 backdrop-blur-md transition-all duration-300"> <div class="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-6"> <a href="/" class="group flex items-center gap-2 text-black no-underline hover:text-black"> <div class="font-extrabold text-xl flex items-center"> <img src="/book.png" alt="Book Logo" class="mr-2 h-8 w-auto">
CIC Handbook
</div> </a> <div class="hidden md:flex gap-8 items-center h-full"> ${navLinks.map(
    (link) => link.dropdown ? renderTemplate`<div class="group relative flex h-full items-center"> <button class="flex h-full cursor-pointer items-center gap-1 bg-transparent p-0 text-[0.95rem] font-medium text-gray-600 transition-colors group-hover:text-[#78081C] focus:outline-none"> ${link.name} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:rotate-180"> <path d="m6 9 6 6 6-6"></path> </svg> </button> <div class="absolute left-1/2 top-[calc(100%-0.5rem)] hidden w-56 -translate-x-1/2 pt-2 group-hover:block"> <div class="overflow-hidden rounded-lg border border-gray-100 bg-white py-2 shadow-xl"> ${link.dropdown.map(
      (subItem) => subItem.active ? renderTemplate`<a${addAttribute(subItem.href, "href")} class="block px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-[#78081C]"> ${subItem.name} </a>` : renderTemplate`<div class="flex cursor-default items-center justify-between bg-gray-50/50 px-4 py-2.5 text-sm text-gray-400"> <span>${subItem.name}</span> <span class="rounded bg-gray-100 px-1.5 py-0.5 text-[0.65rem] font-bold uppercase tracking-wider text-gray-500">
Soon
</span> </div>`
    )} </div> </div> </div>` : renderTemplate`<a${addAttribute(link.href, "href")} class="flex h-full items-center text-[0.95rem] font-medium text-gray-600 no-underline transition-colors hover:text-[#78081C]"> ${link.name} </a>`
  )} </div> <div class="flex items-center gap-3"> <div class="flex items-center"> ${renderComponent($$result, "Search", $$Search, {})} </div> <a href="https://www.google.com.au" class="inline-flex h-10 items-center justify-center rounded-full border-2 border-[#78081c] bg-white px-4 py-2 text-sm font-bold text-[#78081c] no-underline transition hover:bg-[#78081c] hover:text-white">
Quick Exit
</a> </div> </div> </nav> ${renderScript($$result, "/Users/ellievrankovich/projects/cic-handbook/src/components/layout/Header.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/ellievrankovich/projects/cic-handbook/src/components/layout/Header.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Hero.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/PageFrame.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/TableOfContents/TableOfContentsList.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/PageSidebar.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/PageTitle.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Select.astro", void 0);

const $$Astro$9 = createAstro();
const $$LanguageSelect = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$9, $$props, $$slots);
  Astro2.self = $$LanguageSelect;
  return renderTemplate`${starlightConfig.isMultilingual}${renderScript($$result, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/LanguageSelect.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/LanguageSelect.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/SocialIcons.astro", void 0);
...
const $$ThemeSelect = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "width": "6.25em" })} ` }), renderScript($$result, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/ThemeSelect.astro?astro&type=script&index=0&lang.ts"));
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/ThemeSelect.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/MobileMenuFooter.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/SidebarPersister.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/SidebarRestorePoint.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/SidebarSublist.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/Sidebar.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/SkipLink.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/ThemeProvider.astro", void 0);
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/components/TwoColumnContent.astro", void 0);
...
const api = makeAPI([["src/content/docs/index.mdx",1767088811000],["src/content/docs/support-services/index.mdx",1767088811000],["src/content/docs/wa-guide/index.mdx",1767088811000],["src/content/docs/cic-guide/index.mdx",1766982188000],["src/content/docs/home/index.md",1766832480000],["src/content/docs/about-cic/index.mdx",1766761280000],["src/content/docs/guides/example.md",1766747237000],["src/content/docs/reference/example.md",1766747237000]]);const getNewestCommitDate = api.getNewestCommitDate;
...
}, "/Users/ellievrankovich/projects/cic-handbook/node_modules/@astrojs/starlight/routes/common.astro", void 0);
