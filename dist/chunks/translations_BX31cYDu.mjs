...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_0r96vtOq.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BKLem7Ok.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CftEws6K.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_OIlFGZvV.mjs');
...
const starlightConfig = {"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Start Here","translations":{},"collapsed":false,"items":[{"label":"Home","translations":{},"link":"/","attrs":{}}]},{"label":"Western Australia","translations":{},"collapsed":false,"items":[{"label":"WA CIC Guide","translations":{},"link":"/wa-guide","attrs":{}}]},{"label":"Resources","translations":{},"collapsed":false,"items":[{"label":"Support Services","translations":{},"link":"/support-services","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"titleDelimiter":"|","credits":false,"title":{"en":"CIC Handbook"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/ellievrankovich/projects/cic-handbook/","srcDir":"file:///Users/ellievrankovich/projects/cic-handbook/src/","trailingSlash":"ignore"};
